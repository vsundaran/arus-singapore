...
export default function ClientSpeak() {
  ...
  const clientSpeakContent = (
    ...
    >
      Arus transformed our entire data infrastructure in ways we never thought
      possible. Before their intervention, we were drowning in fragmented data
      across 150+ legacy systems. Risk analysis took weeks, regulatory reporting
      was a nightmare, and we were constantly playing catch-up with compliance
      issues. The manual processes were not just inefficient - they were putting
      us at serious risk for fraud detection failures. When Arus came in with
      their data lake solution, everything changed. The real-time processing of
      $100B+ daily transactions seemed impossible, but they delivered.
    </Typography>
  );

  const clientSpeakHeader = (
