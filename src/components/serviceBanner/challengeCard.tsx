...
export default function ChallengeCard() {
  ...
  const challengeContent = (
    ...
    >
      The bank struggled with fragmented data across 150+ legacy systems, making
      risk analysis and regulatory reporting take weeks. Manual processes led to
      compliance issues and missed opportunities for real-time fraud detection.
    </Typography>
  );
